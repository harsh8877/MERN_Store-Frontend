...
const Merchants = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      // Submit new merchant
      await axios.post(`${import.meta.env.VITE_API_URL}/api/merchants`, data, {
        headers: {
      ...
      const updatedList = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/getmerchants`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const toggleDisableMerchant = async (id) => {
    try {
      const response = await axios.put(
        `${import.meta.env.VITE_API_URL}/api/merchants/${id}/disable`,
        {},
        {
          headers: {
  ...
  const deleteMerchant = async (id) => {
    ...
    try {
      await axios.delete(
        `${import.meta.env.VITE_API_URL}/api/merchants/${id}`,
        {
          headers: {
            Authorization: `Bearer ${localStorage.getItem("token")}`,
          },
